...
func GetBlockAndResult(blockNr rpc.BlockNumber) (*types.BlockAndResult, error) {
	...
	err := ClientCall("uni_getBlockAndResultByNumber", result, blockNr)
	return result, err
}
...
func defaultDataDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home, "Library", "uni_ledger")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home, "AppData", "Roaming", "uni_ledger")
		} else {
			return filepath.Join(home, ".uni_ledger")
		}
	}
