...
import (
	...
	"github.com/unichainplatform/unichain/processor/vm/runtime"
	...
	"github.com/unichainplatform/unichain/utils/abi"
...
func createAccount(account *accountmanager.AccountManager, name string) error {
	if err := account.CreateAccount(common.Name("unichain"), common.Name(name), "", 0, 2, common.HexToPubKey("12345"), ""); err != nil {
...
func issueAssetAction(ownerName, toName common.Name) *types.Action {
	...
	action := types.NewAction(types.IssueAsset, ownerName, common.Name("unichain.asset"), 0, 0, 0, big.NewInt(0), b, nil)
	return action
}
...
func TestAsset(t *testing.T) {
	...
	if err := createAccount(account, "unichain.asset"); err != nil {
		return
	}
