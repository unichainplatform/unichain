...
func TestDistributeKeys(t *testing.T) {
	key1 := DistributeKey{ObjectName: common.Name("unitoken"), ObjectType: 0}
	key2 := DistributeKey{ObjectName: common.Name("unitoken"), ObjectType: 1}
	...
	key4 = DistributeKey{ObjectName: common.Name("unitoken"), ObjectType: 0}
	key3 = DistributeKey{ObjectName: common.Name("unitoken"), ObjectType: 1}
