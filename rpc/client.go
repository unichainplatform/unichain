...
// UniSubscribe registers a subscripion under the "ft" namespace.
func (c *Client) UniSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "uni", channel, args...)
}
