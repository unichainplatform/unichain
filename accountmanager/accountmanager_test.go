...
func getAccountManager() *AccountManager {
	...
	am.CreateAccount(common.Name("unichain.founder"), common.Name("systestname"), common.Name(""), 0, 0, *pubkey, "")
	return am
}
...
func TestNN(t *testing.T) {
	if err := accountManager.CreateAccount(common.Name("unichain.founder"), common.Name("a123asdf2"), common.Name(""), 0, 0, *new(common.PubKey), ""); err != nil {
...
func TestAccountManager_CreateAccount(t *testing.T) {
	...
	tests := []struct {
		...
		//
		{"createAccount", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a111222332a"), common.Name(""), pubkey3}, false},
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a123456789aeee"), common.Name(""), *pubkey2}, false},
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a123456789aeed"), common.Name(""), *pubkey}, false},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a12345678-aeee"), common.Name(""), *pubkey}, true},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a123456789aeeefgp"), common.Name(""), *pubkey}, true},
		{"creategensisAccount", fields{sdb, ast}, args{common.Name("unichain"), common.Name("unichain.account"), common.Name(""), *pubkey}, false},
		{"creategensisAccount1", fields{sdb, ast}, args{common.Name("unichain"), common.Name("unichain.asset"), common.Name(""), *pubkey}, false},
		{"createinvalidAccount0", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("\ttesttestf1"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount1", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("testtestf1.."), common.Name(""), *pubkey}, true},
		{"createinvalidAccount2", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("unichain.account"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount3", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("unichain.founder.1"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount4", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("unichain.founder.12"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount5", fields{sdb, ast}, args{common.Name("unichain"), common.Name("unichain.founder1234"), common.Name(""), *pubkey}, true},
	}
	for _, tt := range tests {
		am := &AccountManager{
			sdb: tt.fields.sdb,
	...
	err := am1.CreateAccount(common.Name("unichain.founder"), common.Name("aaaadddd"), common.Name("a111222332a"), 0, 0, *pubkey, "")
	if err != nil {
...
func TestAccountManager_SetAccount(t *testing.T) {
	...
	pubkey2 := new(common.PubKey)
	accountManager.CreateAccount(common.Name("unichain.founder"), common.Name("a123456789"), common.Name(""), 0, 0, *pubkey2, "")
...
func TestAccountManager_GetCode(t *testing.T) {
	...
	accountManager.CreateAccount(common.Name("unichain.founder"), common.Name("a123456789aeed"), common.Name("a123456789aeed"), 0, 0, *pubkey2, "")
...
func Test_IssueAssetForkID1(t *testing.T) {
	...
	//create account
	err := am.CreateAccount(common.Name("unichain.founder"), newAccount, "", 0, 0, *pubkey, "")
...
func Test_GetAccountNameLevel(t *testing.T) {
	level, err := GetAccountNameLevel("unichain")

	if level != 1 || err != nil {
		t.Errorf("account level 1 test failed, level:%v, err:%v", level, err)
	}

	level, err = GetAccountNameLevel("unichain.test")
...
func Test_CheckAssetContract(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"assetContract", args{"unichain.contract", "unichain.contract", "unichain.test"}, true},
		{"assetContract", args{"unichain.contract", "unichain.test1", "unichain.test"}, false},
	}
...
func TestAccountManager_CreateAccountFork1(t *testing.T) {
	...
	tests := []struct {
		...
		{"createAccount", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a111222332afork"), common.Name(""), pubkey3}, false},
		...
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a123456789fork"), common.Name(""), *pubkey2}, false},
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a123456789afork"), common.Name(""), *pubkey}, false},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a12345678-fork"), common.Name(""), *pubkey}, true},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a123456789aeeefork"), common.Name(""), *pubkey}, true},
		{"createAccountNameInvalid", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("a12345678b"), common.Name(""), pubkey3}, true},
		{"createinvalidAccount0", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("\ttesttestf1"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount1", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("testtestf1.."), common.Name(""), *pubkey}, true},
		{"createinvalidAccount2", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("unichain.account"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount3", fields{sdb, ast}, args{common.Name("unichain.founder"), common.Name("unichain.founder.1"), common.Name(""), *pubkey}, true},
...
func TestAccountManager_AccountHaveCode(t *testing.T) {
	...
	err := am.CreateAccount(common.Name("unichain.founder"), common.Name("a111222332code"), common.Name(""), 0, 1, pubkey, "")
	if err != nil {
