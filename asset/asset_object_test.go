...
func Test_newAssetObject(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"normal", args{"uni", "uni", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(999999), ""}, &AssetObject{0, 0, 0, "uni", "uni", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(2), big.NewInt(999999), common.Name(""), ""}, false},
		{"shortname", args{"z", "z", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"longname", args{"unit0123456789unit12", "zz", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"emptyname", args{"", "z", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"symbolempty", args{"uni", "", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"amount==0", args{"uni", "z", big.NewInt(-1), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"ownerempty", args{"uni", "z", big.NewInt(2), 18, common.Name(""), common.Name(""), big.NewInt(999999), ""}, nil, true},
		{"shortsymbol", args{"uni", "z", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"longsymbol", args{"uni", "unit0123456789unit1", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"emptyname", args{"uni", "#ip0123456789uni", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"limiterror", args{"uni", "uni", big.NewInt(101), 18, common.Name(""), common.Name("a123"), big.NewInt(100), ""}, nil, true},
		{"descerror", args{"uni", "uni", big.NewInt(100), 18, common.Name(""), common.Name("a123"), big.NewInt(101),
...
func TestAssetObject_GetAssetID(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"normal", fields{1, "uni", "uni0123456789uni", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(0), big.NewInt(999999)}, 1},
		{"max", fields{18446744073709551615, "uni", "uni0123456789uni", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(0), big.NewInt(999999)}, 18446744073709551615},
		//{"min", fields{0, "uni", "uni0123456789uni", big.NewInt(2), 18, common.Name("a123")}, 0},
		//{">max", fields{18446744073709551616, "uni", "uni0123456789uni", big.NewInt(2), 18, common.Name("a123")}, 0},
	}
	for _, tt := range tests {
		ao := &AssetObject{
...
func TestAssetObject_SetAssetID(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		//{">max", fields{0, "uni", "uni0123456789uni", big.NewInt(2), 18, common.Name("a123")}, args{18446744073709551616}},
		{"max", fields{0, "uni", "uni0123456789uniuni", big.NewInt(2), 18, common.Name("a123")}, args{18446744073709551615}},
		{"normal", fields{0, "uni", "uni0123456789uni", big.NewInt(2), 18, common.Name("a123")}, args{184467}},
	}
	for _, tt := range tests {
		ao := &AssetObject{
			AssetID:   tt.fields.AssetID,
